...
export default function CaseStudies() {
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="bg-gradient-to-br from-slate-50 to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Case{' '}
              <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Studies</span>
            </motion.h1>
            <motion.p 
      ...
      {/* Case Studies Grid */}
      <section ref={studiesRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Explore detailed case studies showcasing how our intelligence solutions 
